...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<div class="container">
		<div class="header clearfix">
			<nav class="nav">
				<ul class="nav-pills pull-right">
					<li role="presentation"><a title="About" class="glyphicon glyphicon-home home" href="#"></a></li>
		...
		<g:layoutBody/>
		<footer class="footer">
			<a href="http://www.softexcel.com">This website is developed in response to GSA RFQ 4QTFHS150004</a>
		</footer>
