		...
		<div id="list-endPoint" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="endPoint" title="${message(code: 'endPoint.endPoint.label', default: 'End Point')}" />
				...
				<g:each in="${endPointInstanceList}" status="i" var="endPointInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${endPointInstance.id}">${fieldValue(bean: endPointInstance, field: "endPoint")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${endPointInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
